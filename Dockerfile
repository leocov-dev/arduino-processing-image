...
RUN tar xvf /opt/processing.tgz --directory /processing
...
RUN mkdir -p /root/documents/processing/libraries
RUN unzip /opt/controlP5.zip -d /root/documents/processing/libraries
